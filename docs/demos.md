...
![Shapes demo](images/demos/shapes.png)
...
![Joints demo](images/demos/joints.png)
...
![Areas demo](images/demos/areas.png)
...
![Contacts demo](images/demos/contacts.png)
...
![Collision exceptions demo](images/demos/exceptions.png)
...
![Trimesh demo](images/demos/trimesh.png)

A `ConcavePolygonShape3D` ramp with crates sliding down it. Trimesh bodies collide normally but are never detected by an `Area3D`, which is a [documented difference](behavior-differences.md).

## Trimesh transforms

![Trimesh transform demo](images/demos/trimesh_transform.png)
...
![Benchmark](images/benchmarks/box3d.png)
...
This needs a real GPU. Running it with `--headless` uses the dummy rasterizer and writes blank images, so the script refuses to run there.
