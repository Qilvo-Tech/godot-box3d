...
if(APPLE AND CMAKE_OSX_ARCHITECTURES)
	string(REPLACE ";" "\\;" GODOT_CPP_OSX_ARCHITECTURES_ARG "${CMAKE_OSX_ARCHITECTURES}")
	list(APPEND GODOT_CPP_TOOLCHAIN_ARGS
		"-DCMAKE_OSX_ARCHITECTURES=${GODOT_CPP_OSX_ARCHITECTURES_ARG}"
	)
endif()

set(GODOT_CPP_PLATFORM_ARGS "")
if(EMSCRIPTEN)
	set(GODOT_CPP_WEB_COMPILE_FLAGS
		"-sSIDE_MODULE=1"
		"-sSUPPORT_LONGJMP=wasm"
		"-DWEB_ENABLED"
		"-DUNIX_ENABLED"
	)
	set(GODOT_CPP_WEB_LINK_FLAGS
		"-sSIDE_MODULE=1"
		"-sSUPPORT_LONGJMP=wasm"
	)
	if(GODOT_BOX3D_WEB_THREADS)
		list(APPEND GODOT_CPP_WEB_COMPILE_FLAGS
			"-pthread"
			"-sUSE_PTHREADS=1"
			"-DTHREADS_ENABLED"
		)
		list(APPEND GODOT_CPP_WEB_LINK_FLAGS "-pthread" "-sUSE_PTHREADS=1")
	endif()
	string(JOIN " " GODOT_CPP_WEB_COMPILE_FLAGS_STRING ${GODOT_CPP_WEB_COMPILE_FLAGS})
	string(JOIN " " GODOT_CPP_WEB_LINK_FLAGS_STRING ${GODOT_CPP_WEB_LINK_FLAGS})
	list(APPEND GODOT_CPP_PLATFORM_ARGS
		"-DCMAKE_C_FLAGS=${GODOT_CPP_WEB_COMPILE_FLAGS_STRING}"
		"-DCMAKE_CXX_FLAGS=${GODOT_CPP_WEB_COMPILE_FLAGS_STRING}"
		"-DCMAKE_EXE_LINKER_FLAGS=${GODOT_CPP_WEB_LINK_FLAGS_STRING}"
		"-DCMAKE_SHARED_LINKER_FLAGS=${GODOT_CPP_WEB_LINK_FLAGS_STRING}"
		"-DCMAKE_MODULE_LINKER_FLAGS=${GODOT_CPP_WEB_LINK_FLAGS_STRING}"
	)
endif()
